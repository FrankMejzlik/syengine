...
bool ShaderManager::LoadStandardShaders()
{
  ...
  NewShader* pShader = CreateShader(
    ...
    PATH_SHADERS STANDARD_SHADER_VS_FILENAME,
    PATH_SHADERS STANDARD_SHADER_FS_FILENAME
  );
  if (pShader == nullptr)
  {
    result = false;
  ...
  pShader = CreateShader(
    ...
    PATH_SHADERS STANDARD_SHADER_VS_SM_ORTHO_FILENAME,
    PATH_SHADERS STANDARD_SHADER_FS_SM_ORTHO_FILENAME
  );
  if (pShader == nullptr)
  {
    result = false;
  ...
  pShader = CreateShader(
    ...
    PATH_SHADERS STANDARD_SHADER_VS_SM_PERSPECTIVE_FILENAME,
    PATH_SHADERS STANDARD_SHADER_FS_SM_PERSPECTIVE_FILENAME,
    std::string_view(),
    PATH_SHADERS STANDARD_SHADER_GS_SM_PERSPECTIVE_FILENAME
  );
  if (pShader == nullptr)
  {
    result = false;
