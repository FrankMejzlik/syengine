...
#define PUSH_ENGINE_ERROR(type, shortDesc, longDesc)  PushEngineError(type, __FILE__, __LINE__, shortDesc, longDesc); DLog(eLogType::cError, "%s (%s)", std::string(shortDesc).c_str(), std::string(longDesc).c_str())
#define PUSH_EDITOR_ERROR(type, shortDesc, longDesc)  PushEngineError(type, __FILE__, __LINE__, shortDesc, longDesc); DLog(eLogType::cError, "%s (%s)", std::string(shortDesc).c_str(), std::string(longDesc).c_str())
